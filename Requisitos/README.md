...
- `Artefatos/Exemplos/`: exemplos prontos de visao, proposta, glossario e requisitos nao funcionais.
- `Artefatos/Templates/`: templates para criacao de novos artefatos.
...
- [Guia de especificação de requisitos não funcionais](Requisitos%20N%C3%A3o%20Funcionais/Especificando%20Requisitos%20N%C3%A3o%20Funcionais.md)

## Boas Praticas

- mantenha nomenclatura consistente dos arquivos;
- atualize os documentos sempre que houver mudanca relevante de escopo;
- preserve historico e contexto dos requisitos para facilitar validacao.
